      ...
      <div class="container-fluid">
	    ...
	    <div class="container shadow p-4 mb-4 bg-white rounded-lg">
		  ...
		  <div class="d-flex justify-content-end">
		  	<button class="btn btn-primary" type="button" onclick="location.href='<%=request.getContextPath()%>/member/modify?id=${member.id }';" >수정</button>&nbsp;&nbsp;&nbsp;
		  	<button class="btn btn-danger" type="button" onclick="location.href='<%=request.getContextPath()%>/member/delete?id=${member.id }';">삭제</button>&nbsp;&nbsp;&nbsp;
		  	<button class="btn btn-secondary" type="button" onclick="location.href='list';">목록</button>
		  </div>
		  <hr/>
